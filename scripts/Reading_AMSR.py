...
def Read_AMSR2_L1R_daily(year,month,day_start,day_stop,directory,**kwargs):
    """
    Read AMSR2 hdf5 data (TB) available at:
    ...
    for day in tqdm(days):
        ...
        for fname in _list_directory(folder,year+month+day,'.h5'):
